...
namespace Synagogue_App
{
    class Roesolution
    {
        public void CWindowsFormsApplication(int a, int b)
        {
                ...
                else
                {
                    ...
                    switch (iRet)
                    {
                        ...
                        case User_32.DISP_CHANGE_RESTART:
                            {
                                MessageBox.Show("Description: You Need To Reboot For The Change To Happen.\n If You Feel Any Problem After Rebooting Your Machine\nThen Try To Change WindowsFormsApplication1 In Safe Mode.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information);
                                break;
                                //windows 9x series you have to restart
                            }
                        default:
                            {
                                MessageBox.Show("Description: Failed To Change The WindowsFormsApplication1.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information);
                                break;
                                //failed to change
                            }
                    }
