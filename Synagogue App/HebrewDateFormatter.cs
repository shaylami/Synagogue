...
namespace Synagogue_App
{
    ...
    /// </ul>
    /// </summary>
    /// <seealso cref= net.sourceforge.zmanim.hebrewcalendar.JewishDate </seealso>
    /// <seealso cref= net.sourceforge.zmanim.hebrewcalendar.JewishCalendar
    /// 
    ...
    public class HebrewDateFormatter
    {
        ...
        private bool longWeekFormat = false;
        ...
        /// <seealso cref= #format(JewishDate) </seealso>
        /// <seealso cref= #formatDayOfWeek(JewishDate) </seealso>
        /// <seealso cref= #formatMonth(JewishDate) </seealso>
        ...
        /// </summary>
        private static readonly string[] hebrewDaysOfWeek = { "\u05E8\u05D0\u05E9\u05D5\u05DF", "\u05E9\u05E0\u05D9", "\u05E9\u05DC\u05D9\u05E9\u05D9", "\u05E8\u05D1\u05D9\u05E2\u05D9", "\u05D7\u05DE\u05D9\u05E9\u05D9", "\u05E9\u05D9\u05E9\u05D9", "\u05E9\u05D1\u05EA" };
        ...
        public virtual string formatDayOfWeek(JewishDate jewishDate)
        {
            if (hebrewFormat)
            {
                ...
                if(hebrewDaysOfWeek == hebrewDaysOfWeek)//IndexOutOfRangeException)
                {
                sb.Append(longWeekFormat ? hebrewDaysOfWeek[jewishDate.DayOfWeek + 5]: formatHebrewNumber(jewishDate.DayOfWeek)); 
